...
export default function Location() {
  ...
  return (
    <section id="location" style={{ padding: "7rem 1.5rem", background: "var(--dark-2)", borderTop: "1px solid #1c1c1c" }}>
      <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
        <div className="fade-up" style={{ textAlign: "center", marginBottom: "3.5rem" }}>
          ...
          <h2 className="heading" style={{ fontSize: "clamp(2rem, 4vw, 3rem)", fontWeight: 800, color: "#fff", marginBottom: "1rem" }}>
            Hours &amp; <span style={{ color: "var(--gold)" }}>Location</span>
          </h2>
        ...
        >
          {/* Hours */}
          <div style={{ background: "var(--dark-3)", border: "1px solid #222", padding: "2rem" }}>
            <h3 style={{ fontWeight: 700, fontSize: "0.75rem", color: "var(--gold)", letterSpacing: "0.2em", textTransform: "uppercase", marginBottom: "1.5rem" }}>
              Opening Hours
            </h3>
            {hours.map((h) => (
              <div
                key={h.day}
                className="hours-row"
                style={{ color: h.day === today ? "#fff" : "#666", fontWeight: h.day === today ? 600 : 400 }}
              >
                <span>{h.day}</span>
                <span style={{ color: h.day === today ? "var(--gold)" : undefined }}>{h.time}</span>
              </div>
            ))}
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
            <div style={{ background: "var(--dark-3)", border: "1px solid #222", padding: "2rem", display: "flex", flexDirection: "column", gap: "1.2rem" }}>
              <h3 style={{ fontWeight: 700, fontSize: "0.75rem", color: "var(--gold)", letterSpacing: "0.2em", textTransform: "uppercase", marginBottom: "0.3rem" }}>
                Contact
              </h3>
              ...
              <div style={{ display: "flex", gap: "1rem", alignItems: "flex-start" }}>
                ...
                <div>
                  ...
                  <a
                    ...
                    style={{ color: "var(--gold)", fontSize: "0.78rem", textDecoration: "none", marginTop: "4px", display: "inline-block" }}
                  >
                    Get Directions →
                  </a>
                </div>
              ...
              <div style={{ display: "flex", gap: "1rem", alignItems: "center" }}>
                ...
                <a href="tel:0286250010" style={{ color: "#ccc", fontSize: "0.9rem", textDecoration: "none" }}>
                  (02) 8625 0010
                </a>
              </div>
            </div>
