    ...
    <section id="location" className="section section-alt">
      <div className="container">
        <div className="reveal" style={{ textAlign: "center", marginBottom: "3.5rem" }}>
          ...
          <h2 className="title">Hours &amp; <span className="accent-text">Location</span></h2>
          <div className="rule" />
        </div>
        ...
        <div className="reveal" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(300px, 1fr))", gap: "1.5rem" }}>
          ...
          <div className="panel" style={{ padding: "2rem" }}>
            <h3 style={{ fontWeight: 700, fontSize: "0.74rem", color: "var(--red)", letterSpacing: "0.22em", textTransform: "uppercase", marginBottom: "1.5rem" }}>
              Opening Hours
            </h3>
            {hours.map((h) => (
              <div key={h.day} className="hours-row" style={{ color: h.day === today ? "var(--text)" : "var(--muted)", fontWeight: h.day === today ? 600 : 400 }}>
                <span>
                  {h.day}
                  {h.day === today && (
                    <span style={{ color: "var(--red)", marginLeft: "0.5rem", fontSize: "0.62rem", letterSpacing: "0.1em", textTransform: "uppercase", fontWeight: 700 }}>
                      Today
                    </span>
                  )}
                </span>
                <span style={{ color: h.day === today ? "var(--text)" : undefined }}>{h.time}</span>
              </div>
            ))}
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
            <div className="panel" style={{ padding: "2rem", display: "flex", flexDirection: "column", gap: "1.3rem" }}>
              <h3 style={{ fontWeight: 700, fontSize: "0.74rem", color: "var(--red)", letterSpacing: "0.22em", textTransform: "uppercase" }}>Contact</h3>

              <div style={{ display: "flex", gap: "1rem", alignItems: "flex-start" }}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--red)" strokeWidth="1.5" style={{ flexShrink: 0, marginTop: "3px" }}>
                ...
                <div>
                  ...
                  <a href="https://maps.google.com/?q=Shop+3/60+Glenwood+Park+Dr+Glenwood+NSW+2768" target="_blank" rel="noopener noreferrer"
                    style={{ color: "var(--red)", fontSize: "0.8rem", fontWeight: 600, textDecoration: "none", marginTop: "5px", display: "inline-block" }}>
                    Get Directions →
                  </a>
                </div>
              </div>
              ...
              <div style={{ display: "flex", gap: "1rem", alignItems: "center" }}>
                <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="var(--red)" strokeWidth="1.5" style={{ flexShrink: 0 }}>
